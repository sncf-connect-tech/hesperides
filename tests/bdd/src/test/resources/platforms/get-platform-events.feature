Feature: Get platform events
  ...
  Scenario: Get platform event "platform_version_updated"
    ...
    When I get this platform's events
    Then the event at index 0 contains "platform_version_updated" with old version "1" and new version "2"
  ...
  Scenario: Get platform event "deployed_module_version_updated"
    ...
    When I get this platform's events
    Then the event at index 0 contains "deployed_module_updated" with old version "1" and new version "2"
  ...
  Scenario: Get platform event "deployed_module_added"
    ...
    When I get this platform's events
    Then the event at index 0 contains "deployed_module_added"
  ...
  Scenario: Get platform event "deployed_module_removed"
    ...
    When I get this platform's events
    Then the event at index 0 contains "deployed_module_removed"
