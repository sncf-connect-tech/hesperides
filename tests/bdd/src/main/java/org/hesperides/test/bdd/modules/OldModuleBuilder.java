...
public class OldModuleBuilder {
    ...
    public OldModuleBuilder() {
        reset();
    }

    public OldModuleBuilder reset() {
        // Valeurs par défaut
        name = "test-module";
        version = "1.0.0";
    ...
    public OldModuleBuilder withName(String name) {
        this.name = name;
        return this;
    }

    public OldModuleBuilder withVersion(String version) {
        this.version = version;
        return this;
    }

    public OldModuleBuilder withVersionType(String versionType) {
        this.versionType = versionType;
        return this;
    }

    public OldModuleBuilder withTechno(TechnoIO techno) {
        technos.add(techno);
        return this;
    }
    ...
    public OldModuleBuilder withVersionId(long versionId) {
    ...
    public OldModuleBuilder withTemplate(TemplateIO template) {
