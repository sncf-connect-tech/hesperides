...
data class SearchModulesQuery(val input: String, val size: Int)
...
data class CountPasswordsQuery(val modulesKeys: List<Module.Key>)
data class GetDistinctTechnoKeysInModulesQuery(val modulesKeys: List<Module.Key>)
