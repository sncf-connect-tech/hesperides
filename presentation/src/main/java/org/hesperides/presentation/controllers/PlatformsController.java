...
public class PlatformsController extends AbstractController {
    ...
    public ResponseEntity<ApplicationOutput> getApplications(@PathVariable("application_name") final String appName) {
        ApplicationView applicationView = platformUseCases.getApplication(appName);
        ApplicationOutput applicationOutput = ApplicationOutput.fromApplicationView(applicationView);
