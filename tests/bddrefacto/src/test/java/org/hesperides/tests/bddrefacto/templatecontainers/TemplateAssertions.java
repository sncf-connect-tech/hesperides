...
public class TemplateAssertions {
    ...
    public static void assertTemplate(TemplateIO expectedTemplate, TemplateIO actualTemplate) {
        assertEquals(expectedTemplate.getNamespace(), actualTemplate.getNamespace());
        ...
        assertEquals(expectedTemplate.getVersionId(), actualTemplate.getVersionId());
    }
