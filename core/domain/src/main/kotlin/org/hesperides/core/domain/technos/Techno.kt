...
// Events
data class TechnoCreatedEvent(val technoId: String, val techno: Techno, override val user: User) : UserEvent(user)

data class TechnoDeletedEvent(val technoId: String, override val user: User) : UserEvent(user)
data class TemplateAddedToTechnoEvent(val technoId: String, val template: Template, override val user: User) : UserEvent(user)
data class TechnoTemplateUpdatedEvent(val technoId: String, val template: Template, override val user: User) : UserEvent(user)
data class TechnoTemplateDeletedEvent(val technoId: String, val templateName: String, override val user: User) : UserEvent(user)
