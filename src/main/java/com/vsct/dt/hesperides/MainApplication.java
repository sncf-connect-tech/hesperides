...
public final class MainApplication extends Application<HesperidesConfiguration> {
    ...
    public void run(final HesperidesConfiguration hesperidesConfiguration, final Environment environment) throws Exception {
        ...
        /* Events aggregate */
        final EventsAggregate eventsAggregate = new EventsAggregate(hesperidesConfiguration.getEventsConfiguration(),
                eventBus, eventStore);
        ...
        final HesperidesStatsResource statsResource = new HesperidesStatsResource(
                new PermissionAwareApplicationsProxy(applicationsAggregate, userContext), modulesAggregate);
        ...
        final HesperidesCacheResource hesperidesCacheResource = new HesperidesCacheResource(templatePackagesAggregate,
