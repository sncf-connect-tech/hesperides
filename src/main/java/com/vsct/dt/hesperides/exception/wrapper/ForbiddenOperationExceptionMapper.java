...
*/
public final class ForbiddenOperationExceptionMapper extends BaseExceptionMapper implements ExceptionMapper<ForbiddenOperationException> {

    @Override
    public Response toResponse(final ForbiddenOperationException e) {
