...
data class TemplateCreatedEvent(val moduleId: String, val template: Template, override val user: String) : UserEvent(user)
data class TemplateUpdatedEvent(val moduleId: String, val template: Template, override val user: String) : UserEvent(user)
data class TemplateDeletedEvent(val moduleId: String, val templateName: String, override val user: String) : UserEvent(user)
